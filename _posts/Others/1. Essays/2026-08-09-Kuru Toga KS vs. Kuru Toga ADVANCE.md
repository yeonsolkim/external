...
For a user who is sensitive to the slight looseness or vertical movement of the ADVANCE mechanism, the KS architecture therefore provides a substantial mechanical advantage even though its rotational correction is slower.
...
although this particular inequality should be regarded as a physically plausible hypothesis rather than a precisely established quantitative result for these specific leads. 
A similar argument applies to darkness $D$: 2B generally responds more strongly to pressure because additional pressure deposits more graphite and binder material onto the paper, whereas HB should exhibit a smaller variation in darkness. 
Thus HB may reduce not only the mean stroke width but also the variance
