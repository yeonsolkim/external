...
This proves Theorem 1.1.10. <span class="qed">$\square$</span>
...
Therefore $\alpha^n=y,$ and this prove Theorem 1.1.11.<span class="qed">$\square$</span>
