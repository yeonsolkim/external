...
Also, $0_{\mathbb C}\neq1_{\mathbb C}$, since $(0,0)\neq(1,0)$. Consequently, $\mathcal C\vDash T_{\mathrm{field}}.$ <span class="qed">$\square$</span>
...
Therefore, $\iota$ preserves the interpretations of all symbols of $\mathcal L_{\mathrm{field}}$. <span class="qed">$\square$</span>
...
For uniqueness, suppose that $x+yi=u+vi$ for some $x,y,u,v\in\mathbb R$. In terms of ordered pairs, this equality is $(x,y)=(u,v).$ Consequently, $x=u$ and $y=v$. <span class="qed">$\square$</span>
...
4. $z\overline z \in \mathbb R^{+},$ if $z\ne 0.$
...
(4) $z\overline z = (x,y)(x,-y) = (x^2+y^2,0)=x^2+y^2.$ Since $z\ne 0,$ at least one of $x$ and $y$ is nonzero so that $0<x^2+y^2 = z\overline z.$ <span class="qed">$\square$</span>

**Definition 1.3.9.** If $z\in \mathbb C,$ its *modulus* $|z|$ is algebraically defined by

$$ |z|^2 = z\overline z.$$

The existence and uniqueness of $|z|$ follows from Theorem 1.1.12 and (4) of Proposition 1.3.8.
...
(2) We let $a=\left( x^2\right)^{1/2}$ and $b = \left( x^2+y^2\right)^{1/2}.$ Then we have $a^2\le b^2.$ Since $a$ and $b$ are nonnegative, $a\le b.$ Thus $|\operatorname {Re} (z) | \le |z|.$<span class="qed">$\square$</span>
...
Let $u=z\overline w$ and $v=\overline z w.$ Then $\overline v= u,$ so that $\text{LHS} = 2\operatorname{Re} (u).$ Also we observe that $\text{RHS} = 2|z| |\overline w| = 2|z\overline w|=  2|u|.$ (2) of Proposition 1.3.10 implies $\operatorname{Re} (u) \le |u|,$ and this proves $\text{LHS} \le \text{RHS}.$ Therefore $|z+w| \le |z| + |w|.$  <span class="qed">$\square$</span>
