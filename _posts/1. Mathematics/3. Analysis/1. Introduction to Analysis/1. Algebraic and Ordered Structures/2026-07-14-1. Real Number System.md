...
last_modified_at: 2026-09-03 09:21:56 +0900
---
...
**Theorem 1.1.11.** For all $y\in \mathbb R^{+}$ and all $n\in \mathbb N^{+},$ there exists the unique $x\in \mathbb R^{+}$ such that
...
**Definition 1.1.12.** Let $x\in \mathbb R$ and $n\in \mathbb N^{+}.$ We define $n$-*th root* of $x$ as follows:
...
**Proposition 1.1.13.** For all $x,y\in \mathbb R^{+}$ and $n\in \mathbb N^{+},$
