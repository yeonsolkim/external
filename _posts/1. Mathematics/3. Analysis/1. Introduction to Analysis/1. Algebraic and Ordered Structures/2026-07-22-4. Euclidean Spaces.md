...
**Definition 1.4.1.** Let $k\in\mathbb N^{+}.$ If $x=(x_1,\dots,x_k)$ and $y=(y_1,\dots,y_k)$ are elements of $\mathbb R^k,$ and $\lambda\in\mathbb R,$ we define the *coordinatewise operations*
