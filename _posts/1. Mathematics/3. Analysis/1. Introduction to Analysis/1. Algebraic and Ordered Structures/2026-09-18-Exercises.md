...
last_modified_at: 2026-09-18 14:50:16 +0900
...
**Exercise 5.** For $a,x\in \mathbb R$ with $a>1$, define $a^x = \sup {A(x)}$. Prove that $a^{x+y} = a^xa^y$ for all $x,y\in \mathbb R$.



**Exercise 6.** If $z_1,\dots,z_n$ are complex, prove that
