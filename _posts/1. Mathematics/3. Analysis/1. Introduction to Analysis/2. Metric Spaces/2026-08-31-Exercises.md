...
publish: false
---
**Exercise 2.1.** Let $(M,d)$ be a metric space, and let $A\subseteq M$. 
...
**Exercise 2.2.** Let $(M,d)$ be a metric space and let $A\subseteq M$. Prove that
...
**Exercise 2.3.** Let $M$ be a metric space, and let $A_1,A_2,\ldots\subseteq M$. Prove that 
