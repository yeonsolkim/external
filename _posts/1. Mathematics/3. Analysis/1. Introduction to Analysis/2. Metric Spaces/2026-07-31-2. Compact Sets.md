...
last_modified_at: 2026-09-12 11:21:46 +0900
---
...
**Theorem 2.2.10.** A metric space $M$ is compact if and only if, for every collection $\lbrace F_i\rbrace_{i\in I}$ of closed subsets of $M$, 

$$ \lbrace F_i\rbrace_{i\in I} \text{ has the FIP}\quad \Longrightarrow \quad \bigcap_{i\in I}F_i \ne \varnothing.$$
