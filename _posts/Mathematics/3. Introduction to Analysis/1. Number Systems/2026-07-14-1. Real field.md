...
last_modified_at: 2026-07-20 18:02:13 +0900
---
...
(2) We have $0<x.$ Since $0<y,$ it follows that $0y<x\cdot y.$ But we also have the relation between $0$ and $0\cdot y,$ $0=0\cdot y.$ Therefore $0<x\cdot y.$<br>
...
(4) If $1/x\le 1/y$ then $x(1/x)<y(1/x)\le y(1/y).$ If follows that $x(1/x)<y(1/y),$ which contradicts $x(1/x)=1=y(1/y).$ Therefore it is concluded that $1/y< 1/x.$<br>
