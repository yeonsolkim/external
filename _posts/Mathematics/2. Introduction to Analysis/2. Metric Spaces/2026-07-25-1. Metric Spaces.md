...
last_modified_at: 2026-08-06 17:56:21 +0900
---
...
**Theorem 2.1.23.** Let $(M,d)$ be a metric space and let $A\subseteq E\subseteq M.$ Then, $A$ is open relative to $E$ if and only if there exists an open set $X\subseteq M$ such that $A = X\cap E.$<br><br>
...
Since every open ball is open, $X$ is open by Theorem 2.1.18.<br>
