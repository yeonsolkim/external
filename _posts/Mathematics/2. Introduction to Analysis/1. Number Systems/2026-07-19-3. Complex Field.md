...
&emsp;&emsp;We define the distinguished elements of $\mathbb C$ by
...
&emsp;&emsp;For multiplication, let $(x,y),(u,v),(r,s)\in\mathbb C$. Direct calculation gives
...
&emsp;&emsp;(1) Since $z+w = (x,y) + (u,v) = (x+u,y+v),$ $\overline {z+w} = (x+u,-(y+v)).$ Also $\overline z + \overline w = (x,-y) + (u,-v) = (x+u,(-y)+(-v)) = (x+u, -(y+v)).$ Hence $\overline{z+w} = \overline z + \overline w.$<br>
&emsp;&emsp;(2) Since $zw = (xu-yv,xv+yu),$ $\overline {zw} = (xu-yv,-(xv+yu)).$ Also $\overline z \cdot \overline w = (x,-y)(u,-v) = (xu-yv,-xv-yu) =  (xu-yv,-(xv+yu)).$ Hence $\overline {zw} = \overline z \cdot \overline w.$ <br>
&emsp;&emsp;(3) $z+\overline z = (x,y) + (x,-y) = (2x,0) = 2x = 2\operatorname{Re}(z).$<br>
&emsp;&emsp;(4) $z\overline z = (x,y)(x,-y) = (x^2+y^2,0)=x^2+y^2.$ Since $z\ne 0,$ at least one of $x$ and $y$ is nonzero so that $0<x^2+y^2 = z\overline z.$ <span class="qed">$\square$</span><br>
<br>
...
&emsp;&emsp;Note that if $z$ is real, then $\overline z = z,$ hence $|z| = \left(z^2\right)^{\! 1/2}.$ Thus $|z| = z$ if $0\le z,$ or $|z| = -z$ if $z<0.$<br>
<br>
...
*Proof.* Let $z = (x,y)$ and $w = (u,v)$ where $x,y,u,v\in \mathbb R.$<br>
&emsp;&emsp;(1) Since $zw = (xu-yv,xv+yu),$ $(zw)\overline {(zw)} = x^2u^2 + y^2v^2 + x^2v^2 + y^2u^2 = (x^2+y^2)(u^2+v^2).$ Hence $|zw| = \left((x^2+y^2)(u^2+v^2)\right)^{\!1/2}=\left(x^2+y^2\right)^{\!1/2}\left(u^2+v^2\right)^{\!1/2} = |z||w|.$<br>
&emsp;&emsp;(2) We let $a=\left( x^2\right)^{1/2}$ and $b = \left( x^2+y^2\right)^{1/2}.$ Then we have $a^2\le b^2.$ Since $a$ and $b$ are nonnegative, $a\le b.$ Thus $|\operatorname {Re} (z) | \le |z|.$<span class="qed">$\square$</span><br>
<br>
...
&emsp;&emsp;Now we suppose that for some $n\ge 3,$
