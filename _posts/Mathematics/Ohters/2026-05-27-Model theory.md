...
category_path:
  - Mathematics
  - Ohters
last_modified_at: 2026-06-20 12:29:12 +0900
...
**Definition 2.** An $\mathcal{L}$-$structure\,\mathcal{M}$ is given by the following data:
...
**Definition 4.** The set of $\mathcal L$-$terms$ is the smallest set $\mathcal T$ such that
...
**Definition 5.** We say that $\phi$ is an $atomic\,\mathcal L$-$formula$ if $\phi$ is either 
...
**Definition 6.** Let $\phi$ be a formula with free variables from $\bar v=(v_{i_1},\dots,v_{i_m})$, and let $\bar a=(a_{i_1},\dots,a_{i_m})\in M^m$. We can inductively define $\mathcal M \vDash \phi (\bar a)$. If $\mathcal M \vDash \phi (\bar a)$ we say that $\phi (\bar a)$ is $true$ in $\mathcal M$.<br>
<br>

**Definition 7.** We say that two $\mathcal L$-structures $\mathcal M$ and $\mathcal N$ are $elementarily\ equivalent$ and write $\mathcal M \equiv \mathcal N$ if 
...
**Definition 8.** An $\mathcal L$-$theory\ T$ is simply a set of $\mathcal L$-sentences. We say that $\mathcal M$ is a $model$ of $T$ and write $\mathcal M \vDash T$ if $\mathcal M \vDash \phi$ for all sentences $\phi \in T$. And, we say that a theory is $satisfiable$ if it has a model.<br>
<br>
