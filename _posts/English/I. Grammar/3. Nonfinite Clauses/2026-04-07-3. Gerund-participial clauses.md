...
> Semantics: (Learning (Chinese)) is (easy)
...
> Semantics: (I) am (sorry) → (for giving (you) (trouble))
...
> Semantics: (She) is (tired) → (of (Lucy's) being (late))
...
> Semantics: It is (nice) (seeing (him) (again)) 
...
> Semantics: (Smiling (brightly)) (the girl) turned (toward him)
